...
import './ShowData.css'; // Assuming a CSS file for styling
          ...
          <div className="details-content">
            ...
            {prediction && !loading && (
              ...
              <div className="prediction-container">
                <h4>Predicted Average Rainfall for {selectedState} in 2028: {prediction[prediction.length - 1][1].toFixed(2)} mm</h4>
              </div>
              <div className="prediction-container">
               {accuracy !== null && (
                  <h4>
